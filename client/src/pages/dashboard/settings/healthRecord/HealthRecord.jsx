...
import { useEffect, useState } from "react"; //use memos are used to avoid re-rendering of components when their props change. saying it would optimize a value when nothing changes
...
export default function HealthRecord() {
  useMetaArgs({
    title: "Patient Health Record - Clincare",
    description: "View and manage your health records",
    keywords: "Health, Records, Clinic, Hospital",
  });
        ...
        >
          ...
          <div className=" md:hidden my-6 flex items-center justify-center gap-4">
            <button
              ...
              onClick={() => navigate("/dashboard/settings/health")}
            >
              Cancel
            </button>
            <button
